...
This project involved vast exploratory design work, in preparation of the actual implementation.
	...
	\begin{enumerate}[label=\bfseries Extension \arabic*]
		...
		\item \label{ext:transform_sketch} Transform user-drawn sketches to show the visual link to the formal chart elements.
		\item \label{ext:formal_to_informal} Feed back manipulations applied to the formal layer back to the user drawn sketches, in order to keep the visuals of the formal and sketch layers in synchronisation.
	...
	\begin{quote}
	%TODO Discuss that this is not actually an error.
